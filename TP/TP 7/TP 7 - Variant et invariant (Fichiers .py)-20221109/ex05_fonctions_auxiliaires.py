...
def test_permuter():
  ...
  tab = [0,1,2,3,4,5]
  permuter(tab,0,5)
  assert tab==[5,1,2,3,4,0], 'Étape 1'
  permuter(tab,2,3)
  assert tab==[5,1,3,2,4,0], 'Étape 2'
  permuter(tab,3,5)
  assert tab==[5,1,3,0,4,2], 'Étape 3'
  permuter(tab,2,0)
  assert tab==[3,1,5,0,4,2], 'Étape 4'
  permuter(tab,1,1)
  assert tab==[3,1,5,0,4,2], 'Étape 5'
  print('  OK')
